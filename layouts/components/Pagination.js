        ...
        >
          ...
          {hasPrevPage ? (
            <button
              ...
              className="inline-flex h-11 w-11 items-center justify-center rounded px-2 py-2 text-primary hover:bg-primary hover:text-body transition-colors"
            >
              <TfiAngleLeft />
            </button>
          ) : (
            <span
              className="inline-flex h-11 w-11 items-center justify-center rounded px-2 py-2 text-gray-400 cursor-not-allowed"
            >
              <TfiAngleLeft />
            </span>
          )}
            ...
            <React.Fragment key={`page-${i}`}>
              {pagination === currentPage ? (
                ...
                <button
                  ...
                  className="inline-flex h-11 w-11 items-center justify-center rounded-md px-4 py-2 font-medium text-primary hover:bg-primary hover:text-body transition-colors"
                >
                  {pagination}
                </button>
              )}
